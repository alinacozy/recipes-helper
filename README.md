...
![Схема взаимодействия компонентов](help_images/Component_interaction_diagram.svg)

## Логическая схема базы данных:
![Схема взаимодействия компонентов](help_images/Logical_database_diagram.svg)
