...
![Схема взаимодействия компонентов](images/Logical_database_diagram1.png)
...
11. */recipes/{id_recipe}* - **POST** - если ингридиентов хватает для приготовления, на данной странице находится кнопка "Приготовить", по нажатию на которую отправляется POST-запрос, заносится информация о приготовленном рецепте в историю приготовления, а также уменьшается количество продуктов в хранилище.
...
14. */history* - **GET** - история приготовленных рецептов конкретного пользователя.
